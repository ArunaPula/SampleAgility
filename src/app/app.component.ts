...
@Component({
  ...
  animations: [
    trigger('slideInOut', [
      state('in', style({
        transform: 'translate3d(-100%,100px, -200px)'
      })),
      state('out', style({
...
export class AppComponent {
 ...
 pageSize : number = 5;
  ...
  marginLeft:number=241;
  spanclass1='span-active';
  spanclass2='span-inactive';
  tab1=true;
  tab2=false;
  sideclass='main-container';
  ...
  private loadItems(): void {
      this.gridView = {
          data: this.gridData.slice(this.skip, this.skip + this.pageSize1),
  ...
  toggleMenu() {
    ...
    this.marginLeft = this.marginLeft === 241 ? 0 : 241;
    if(this.menuState=='in')
    {
      this.sideclass='main-container-sideview';
    }
    else{
      this.sideclass='main-container';
    }
  }
  toggleMenu1() {
    // 1-line if statement that toggles the value:
    ...
    if(this.menuState1=='out')
    {
      this.spanclass1='span-active';
      this.spanclass2='span-inactive';
      this.tab1=true;
      this.tab2=false;
    }
    else if(this.menuState2=='out')
    {
      this.spanclass1='span-inactive';
      this.spanclass2='span-active';
      this.tab1=false;
      this.tab2=true;
    }
  }
...
FilterByName(event:any){
 ...
 if(event != ""){
       productList.forEach(element => {
           if(element.name.toUpperCase().indexOf(event.toUpperCase())>=0){
